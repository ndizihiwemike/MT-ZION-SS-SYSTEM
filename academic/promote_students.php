...
<head>
<title>MTZSS - Promote Students</title>
<meta charset="utf-8">
...
<li><a class="treeview-item active" href="academic/promote_students"><i class="icon bi bi-circle-fill"></i> Promote Students</a></li>
</ul>
</li>
...
<form enctype="multipart/form-data" action="academic/core/promote_students" class="app_frm" method="POST" autocomplete="OFF">
...
<div class="">
<button class="btn btn-primary app_btn" type="submit">Promote Students</button>
</div>
</form>
</div>
